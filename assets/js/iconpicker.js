    ...
    Run: function (theButton, theCallback) {
        ...
        var appendIconListToBody = function (data, buttonShowAll, buttonCancel, searchPlaceholder, borderRadius, inputElement, previewElement, theCallback) {
            ...
            var iconWrap = '<div class="ip-icons-content" style="border-radius:' + borderRadius + ';">' +
                '<div class="ip-icons-search"><input id="IconPickerSearch" type="text" spellcheck="false" autocomplete="off" placeholder="' + searchPlaceholder + '" style="border-radius:' + borderRadius + ';" /><i class="placeholder-icon fa-duotone fa-solid fa-magnifying-glass"></i></div>' +
                ...
                '</div>' +
                '<div class="ip-icons-footer"><a class="ip-close-dialog btn btn-primary">' + buttonCancel + '</a></div>' +
                '</div>';
            ...
            var cancelButtonElm = document.getElementById(IconPickerModal.id).getElementsByClassName('ip-close-dialog')[0];
                ...
                for (var i = 0; i < eachIconElm.length; i++) {
                    ...
                    singleIconElm.addEventListener('click', function (e) {
                        ...
                        for (var i = 0; i < previewElm.length; i++) {
                            previewElm[i].className = iconClassName + ' fa-4x';
                        }
                        // each preview off
