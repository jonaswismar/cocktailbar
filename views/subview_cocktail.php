			<?php 
				...
				{
					echo '
										<source srcset="../img/cocktails/webp48/' . $image . '.webp" type="image/webp">';
				}
				if(file_exists($currentfilepath .'/img/cocktails/png48/' . $image . '.png'))
				{
					echo '
										<source srcset="../img/cocktails/png48/' . $image . '.png" type="image/png">';
				}
				if(file_exists($currentfilepath .'/img/glassware/webp48/' . $glass . '.webp'))
				{
					echo '
										<source srcset="../img/glassware/webp48/' . $glass . '.webp" type="image/webp">';
				}
				if(file_exists($currentfilepath .'/img/glassware/jpg48/' . $glass . '.jpg'))
				{
					echo '
										<source srcset="../img/glassware/jpg48/' . $glass . '.jpg" type="image/jpg">';
				}?>
									...
									<strong> <?php echo $cocktailname;?></strong> löschen?</h4>
