						...
						if(file_exists($currentfilepath .'/img/ingredients/png48/unbekannt.png'))
						{
							echo '
								...
								<img loading="lazy" src="../img/ingredients/png48/unbekannt.png" alt="<?php echo $ingredientname;?>" class="border border-secondary text-dark rounded-circle bg-white flex-shrink-0" style="text-align: center;">
									...
									<strong> <?php echo $ingredientname;?></strong> löschen?</h4>
								<button type="button" class="btn-close" data-bs-dismiss="modal"></button>
							</div>
							<div class="modal-body">
							...
							<div class="modal-footer">
								<a href="ingredient_delete.php?ingredientid=<?php echo $id;?>" class="btn btn-danger<?php if($_SESSION["role"] != 1){echo ' disabled';}?>">Trotzdem löschen</a>
								<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Abbrechen</button>
							</div>
						</div>
					</div>
					...
					<fieldset>
						<div class="d-flex gap-3 p-3 flex-row justify-content-center">
							...
							<div class="btn-group">
								...
								<a href="ingredient_save.php?ingredientid=<?php echo $id;?>&favorite=<?php if($favorite == 0){echo '1';}else{echo '0';}?>" class="btn btn-primary"><i class="fa-fw fa-2x <?php if($favorite == 0){echo 'fa-regular fa-heart';}else{echo 'fa-solid fa-heart';}?>"></i></a>
							</div>
						</div>
						...
						{
							echo '
								<source srcset="../img/ingredients/webp700/' . $image . '.webp" type="image/webp" media="(min-width: 3840px)">';
						}
						if(file_exists($currentfilepath .'/img/ingredients/webp512/' . $image . '.webp'))
						{
							echo '
								<source srcset="../img/ingredients/webp512/' . $image . '.webp" type="image/webp" media="(min-width: 1600px)">';
						}
						if(file_exists($currentfilepath .'/img/ingredients/webp256/' . $image . '.webp'))
						{
							echo '
								<source srcset="../img/ingredients/webp256/' . $image . '.webp" type="image/webp" media="(min-width: 960px)">';
						}
						if(file_exists($currentfilepath .'/img/ingredients/webp128/' . $image . '.webp'))
						{
							echo '
								<source srcset="../img/ingredients/webp128/' . $image . '.webp" type="image/webp">';
						}
						if(file_exists($currentfilepath .'/img/ingredients/png700/' . $image . '.png'))
						{
							echo '
								<source srcset="../img/ingredients/png700/' . $image . '.png" type="image/png" media="(min-width: 3840px)">';
						}
						if(file_exists($currentfilepath .'/img/ingredients/png512/' . $image . '.png'))
						{
							echo '
								<source srcset="../img/ingredients/png512/' . $image . '.png" type="image/png" media="(min-width: 1600px)">';
						}
						if(file_exists($currentfilepath .'/img/ingredients/png256/' . $image . '.png'))
						{
							echo '
								<source srcset="../img/ingredients/png256/' . $image . '.png" type="image/png" media="(min-width: 960px)">';
						}
						if(file_exists($currentfilepath .'/img/ingredients/png128/' . $image . '.png'))
						{
							echo '
								<source srcset="../img/ingredients/png128/' . $image . '.png" type="image/png">';
						}
						if(file_exists($currentfilepath .'/img/ingredients/png700/unbekannt.png'))
						{
							echo '
								<source srcset="../img/ingredients/png700/unbekannt.png" type="image/png" media="(min-width: 3840px)">';
						}
						if(file_exists($currentfilepath .'/img/ingredients/png512/unbekannt.png'))
						{
							echo '
								<source srcset="../img/ingredients/png512/unbekannt.png" type="image/png" media="(min-width: 1600px)">';
						}
						if(file_exists($currentfilepath .'/img/ingredients/png256/unbekannt.png'))
						{
							echo '
								<source srcset="../img/ingredients/png256/unbekannt.png" type="image/png" media="(min-width: 960px)">';
						}
						if(file_exists($currentfilepath .'/img/ingredients/png128/unbekannt.png'))
						{
							echo '
								<source srcset="../img/ingredients/png128/unbekannt.png" type="image/png">';
						}?>
