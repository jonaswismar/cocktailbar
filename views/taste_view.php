			...
			?>
				<nav class="navbar navbar-dark fixed-top bg-primary text-white" style="z-index: 900; margin-top: 56px;"<?php if($_SESSION["role"] != 1){echo ' hidden';}?>>
					<div class="container-fluid justify-content-start">
						<button type="button" class="btn btn-primary<?php if($_SESSION["role"] != 1){echo ' disabled';}?>" data-bs-toggle="modal" data-bs-target="#newDialogTaste">
							<i class="fa-duotone fa-solid fa-file fa-fw"></i>
						</button>
						<button type="button" class="btn btn-primary<?php if($_SESSION["role"] != 1){echo ' disabled';}?>" data-bs-toggle="modal" data-bs-target="#editDialogTaste">
							<i class="fa-duotone fa-solid fa-pencil fa-fw"></i>
						</button>
						<button type="button" class="btn btn-primary<?php if($_SESSION["role"] != 1){echo ' disabled';}?>" data-bs-toggle="modal" data-bs-target="#deleteDialogTaste">
								...
								<fieldset>
									...
									<div class="modal-body">
										...
										<div class="d-flex p-3 justify-content-around flex-wrap">
											<input name="tasteimage" class="form-control form-control-lg" type="text" placeholder="Fontawesome Icon Name">
										</div>
										<div class="d-flex p-3 justify-content-around flex-wrap">
											<input name="tastename" class="form-control form-control-lg" type="text" placeholder="Name der Geschmacksrichtung">
										</div>
										<div class="d-flex p-3 justify-content-around flex-wrap">
											<textarea name="tastedescription" class="form-control auto-resize" type="text" placeholder="Beschreibung der Geschmacksrichtung" rows="25"></textarea>
										</div>
									</div>
							...
							<form id="taste_edit" action="/views/taste_save.php">
								<fieldset>
									...
									<div class="modal-body">
										...
										<div class="d-flex p-3 justify-content-around flex-wrap">
											<input name="tasteimage" class="form-control form-control-lg" type="text" placeholder="Fontawesome Icon Name" value="<?php echo $tasteimage;?>">
										</div>
										<div class="d-flex p-3 justify-content-around flex-wrap">
											<input name="tastename" class="form-control form-control-lg" type="text" placeholder="Name der Geschmacksrichtung" value="<?php echo $tastename;?>">
										</div>
										<div class="d-flex p-3 justify-content-around flex-wrap">
											<textarea name="tastedescription" class="form-control auto-resize" type="text" placeholder="Beschreibung der Geschmacksrichtung" rows="25"><?php echo $tastedescription;?></textarea>
										</div>
									</div>
									<div class="modal-footer">
										<input class="btn btn-primary" type="submit" name="save" value="Speichern">
				...
				<div class="list-group">
					<?php
						$stmt_sql_cocktails = mysqli_prepare($link, $sql_taste_usedin);
