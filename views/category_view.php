<?php include("header.php") ?>
			...
			<nav class="navbar navbar-dark fixed-top bg-primary text-white" style="z-index: 900; margin-top: 56px;"<?php if($_SESSION["role"] != 1){echo ' hidden';}?>>
					<div class="container-fluid justify-content-start">
						<button type="button" class="btn btn-primary<?php if($_SESSION["role"] != 1){echo ' disabled';}?>" data-bs-toggle="modal" data-bs-target="#newDialogCategory">
							<i class="fa-duotone fa-solid fa-file fa-fw"></i>
						</button>
						<button type="button" class="btn btn-primary<?php if($_SESSION["role"] != 1){echo ' disabled';}?>" data-bs-toggle="modal" data-bs-target="#editDialogCategory">
							<i class="fa-duotone fa-solid fa-pencil fa-fw"></i>
						</button>
						<button type="button" class="btn btn-primary<?php if($_SESSION["role"] != 1){echo ' disabled';}?>" data-bs-toggle="modal" data-bs-target="#deleteDialogCategory">
								...
								<fieldset>
									...
									<div class="modal-body">
										...
										<div class="d-flex p-3 justify-content-around flex-wrap">
											<input name="categoryimage" class="form-control form-control-lg" type="text" placeholder="Fontawesome Icon Name">
										</div>
										<div class="d-flex p-3 justify-content-around flex-wrap">
											<input name="categoryname" class="form-control form-control-lg" type="text" placeholder="Name der Kategorie">
										</div>
										<div class="d-flex p-3 justify-content-around flex-wrap">
											<textarea name="categorydescription" class="form-control auto-resize" type="text" placeholder="Beschreibung der Kategorie" rows="25"></textarea>
										</div>
									</div>
							...
							<form id="category_edit" action="/views/category_save.php">
								<fieldset>
									...
									<div class="modal-body">
										...
										<div class="d-flex p-3 justify-content-around flex-wrap">
											<input name="categoryimage" class="form-control form-control-lg" type="text" placeholder="Fontawesome Icon Name" value="<?php echo $categoryimage;?>">
										</div>
										<div class="d-flex p-3 justify-content-around flex-wrap">
											<input name="categoryname" class="form-control form-control-lg" type="text" placeholder="Name der Kategorie" value="<?php echo $categoryname;?>">
										</div>
										<div class="d-flex p-3 justify-content-around flex-wrap">
											<textarea name="categorydescription" class="form-control auto-resize" type="text" placeholder="Beschreibung der Kategorie" rows="25"><?php echo $categorydescription;?></textarea>
										</div>
									</div>
									<div class="modal-footer">
										<input class="btn btn-primary" type="submit" name="save" value="Speichern">
