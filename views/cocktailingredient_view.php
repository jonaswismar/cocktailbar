			...
			<div class="modal fade" id="newDialogCocktailingredient">
				<div class="modal-dialog modal-xl modal-fullscreen-sm-down">
					<div class="modal-content">
						<form id="cocktailingredient_edit" action="/views/cocktailingredient_save.php">
							<fieldset>
								...
								<div class="modal-body">
									<div class="d-flex p-3 justify-content-around flex-wrap">
										...
										<select id="input-tags-ingredient" name="ingredientid[]" autocomplete="off" multiple class="form-control w-100" data-toggle="tooltip" data-placement="bottom" title="Zutat">
<?php 
...
?>
					...
					<form class="align-self-center" action="cocktailingredient_save.php">
						<fieldset class="row">
...
?>
							...
							<div class="align-self-center gap-0 col-2">
								<a href="cocktailingredient_delete.php?cocktailid=<?php echo $cocktailid;?>&ingredientid=<?php echo $ingred_all_rows['ingredient_ID'];?>" class="btn btn-danger">Löschen</a>
							</div>
						</fieldset>
					</form>
				</div>
