<?php include("header.php") ?>
			<nav class="navbar navbar-dark fixed-top bg-primary text-white" style="z-index: 900; margin-top: 56px">
				<div class="scrolling-wrapper-flexbox">
					<a href="categorys.php" class="btn btn-primary text-uppercase active" aria-current="page" data-toggle="tooltip" data-placement="bottom" title="Cocktail Kategorien">
...
?>
						<a href="category_view.php?categoryid=<?php echo $categorys_all_rows['ID'];?>" class="list-group-item list-group-item-action d-flex gap-3 py-3">
							...
							<span style="width: 50px; display: block;" class="badge bg-primary rounded-pill" data-toggle="tooltip" data-placement="bottom" title="<?php echo $categorys_all_rows['total_cocktails'];?> Cocktails der Kategorie <?php echo $categorys_all_rows['categoryname'];?>"><?php echo $categorys_all_rows['total_cocktails'];?></span>
						</a>
<?php
	}
