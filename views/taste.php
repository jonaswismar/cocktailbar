...
?>
			...
			<div class="modal fade" id="newDialogTaste">
				<div class="modal-dialog modal-xl modal-fullscreen-sm-down">
					<div class="modal-content">
						<form id="taste_edit" action="/api/taste_save.php">
							<fieldset>
				...
				<div class="modal-dialog modal-xl modal-fullscreen-sm-down">
					<div class="modal-content">
						<form id="taste_edit" action="/api/taste_save.php">
							<fieldset>
								<div class="modal-header">
									<h4 class="modal-title"><i class="<?php echo $tasteicon;?> fa-2x"></i><strong> <?php echo $tastename;?></strong> bearbeiten</h4>
									<button type="button" class="btn-close" data-bs-dismiss="modal"></button>
								</div>
								<div class="modal-body">
			...
			<div class="modal fade" id="deleteDialogTaste">
				<div class="modal-dialog modal-xl modal-fullscreen-sm-down">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title"><i class="<?php echo $tasteicon;?> fa-2x"></i><strong> <?php echo $tastename;?></strong> löschen</h4>
							<button type="button" class="btn-close" data-bs-dismiss="modal"></button>
						</div>
						<div class="modal-body">
						...
						<div class="modal-footer">
							<a href="/api/taste_delete.php?tasteid=<?php echo $tasteid;?>" class="btn btn-danger<?php if($_SESSION["role"] != 1){echo ' disabled';}?>">Trotzdem löschen</a>
							<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Abbrechen</button>
						</div>
					</div>
				</div>
			...
			<form action="taste_save.php" method="POST">
				<fieldset>
					<div class="d-flex gap-3 p-3 flex-row justify-content-center">
						<i class="<?php echo $tasteicon;?> fa-4x"></i>
						<input name="tasteicon" class="form-control" type="hidden" value="<?php echo $tasteicon;?>" autocomplete="off" spellcheck="false" readonly>
						<input name="tasteid" class="form-control" type="hidden" value="<?php echo $tasteid;?>" readonly>
