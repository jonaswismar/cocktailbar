				...
				<form action="cocktail_save.php" method="POST">
					<fieldset>
						...
						<div class="d-flex justify-content-center">
							...
							<img loading="lazy" class="text-dark rounded-circle bg-white flex-shrink-0" src="../img/cocktails/png128/<?php echo $image;?>" alt="<?php echo $cocktailname;?>" width="128" height="128" style="text-align: center;">
						</div>
						<div class="d-flex gap-3 p-3 flex-row justify-content-center">
