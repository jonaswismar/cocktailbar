...
?>
			...
			<div class="modal fade" id="newDialogIngredienttype">
				<div class="modal-dialog modal-xl modal-fullscreen-sm-down">
					<div class="modal-content">
						<form id="ingredienttype_edit" action="/views/ingredienttype_save.php">
							<fieldset>
								...
								<div class="modal-body">
									...
									<div class="d-flex p-3 justify-content-around flex-wrap">
										<input name="ingredienttypeimage" class="form-control form-control-lg" type="text" placeholder="Fontawesome 6.6.0 Pro Icon Name" data-toggle="tooltip" data-placement="bottom" title="Fontawesome 6.6.0 Pro Icon Name">
									</div>
									<div class="d-flex p-3 justify-content-around flex-wrap">
				...
				<div class="modal-dialog modal-xl modal-fullscreen-sm-down">
					<div class="modal-content">
						<form id="ingredienttype_edit" action="/views/ingredienttype_save.php">
							<fieldset>
								<div class="modal-header">
									<h4 class="modal-title"><i class="<?php echo $image;?> fa-2x"></i><strong> <?php echo $typename;?></strong> bearbeiten</h4>
									<button type="button" class="btn-close" data-bs-dismiss="modal"></button>
								</div>
								<div class="modal-body">
									<input name="ingredienttypeid" class="form-control" type="hidden" value="<?php echo $id;?>" readonly>
									<div class="d-flex p-3 justify-content-around flex-wrap">
										<input name="ingredienttypeimage" class="form-control form-control-lg" type="text" placeholder="Fontawesome 6.6.0 Pro Icon Name" data-toggle="tooltip" data-placement="bottom" title="Fontawesome 6.6.0 Pro Icon Name" value="<?php echo $image;?>">
									</div>
									<div class="d-flex p-3 justify-content-around flex-wrap">
			...
			<div class="modal fade" id="deleteDialogIngredienttype">
				<div class="modal-dialog modal-xl modal-fullscreen-sm-down">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title"><i class="<?php echo $image;?> fa-2x"></i><strong> <?php echo $typename;?></strong> löschen</h4>
							<button type="button" class="btn-close" data-bs-dismiss="modal"></button>
						</div>
						<div class="modal-body">
						...
						<div class="modal-footer">
							<a href="ingredienttype_delete.php?ingredienttypeid=<?php echo $id;?>" class="btn btn-danger<?php if($_SESSION["role"] != 1){echo ' disabled';}?>">Trotzdem löschen</a>
							<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Abbrechen</button>
						</div>
					</div>
				</div>
