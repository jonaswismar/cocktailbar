...
?>
				<a href="/views/ingredient.php?&ingredientid=<?php echo $ingred_all_rows['ingredient_ID'];?>" class="<?php if($ingred_all_rows['available'] == 0){echo "bg-secondary-subtle";}else{echo "bg-primary-subtle";} ?> list-group-item list-group-item-action d-flex gap-2 py-2 d-block">
					<picture>
<?php
