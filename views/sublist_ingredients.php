...
<a href="ingredient_view.php?&ingredientid=<?php echo $ingred_all_rows['ingredient_ID'];?>" class="<?php if($ingred_all_rows['available'] == 0){echo "bg-secondary-subtle";}else{echo "bg-primary-subtle";} ?> list-group-item list-group-item-action d-flex gap-2 py-2 d-block">
						...
						{
							echo '
								<source srcset="../img/ingredients/webp128/' . $ingred_all_rows['image'] . '.webp" type="image/webp" media="(min-width: 1600px)">';
						}
						if(file_exists($currentfilepath .'/img/ingredients/webp64/' . $ingred_all_rows['image'] . '.webp'))
						{
							echo '
								<source srcset="../img/ingredients/webp64/' . $ingred_all_rows['image'] . '.webp" type="image/webp" media="(min-width: 960px)">';
						}
						if(file_exists($currentfilepath .'/img/ingredients/webp48/' . $ingred_all_rows['image'] . '.webp'))
						{
							echo '
								<source srcset="../img/ingredients/webp48/' . $ingred_all_rows['image'] . '.webp" type="image/webp">';
						}
						if(file_exists($currentfilepath .'/img/ingredients/png128/' . $ingred_all_rows['image'] . '.png'))
						{
							echo '
								<source srcset="../img/ingredients/png128/' . $ingred_all_rows['image'] . '.png" type="image/png" media="(min-width: 1600px)">';
						}
						if(file_exists($currentfilepath .'/img/ingredients/png64/' . $ingred_all_rows['image'] . '.png'))
						{
							echo '
								<source srcset="../img/ingredients/png64/' . $ingred_all_rows['image'] . '.png" type="image/png" media="(min-width: 960px)">';
						}
						if(file_exists($currentfilepath .'/img/ingredients/png48/' . $ingred_all_rows['image'] . '.png'))
						{
							echo '
								<source srcset="../img/ingredients/png48/' . $ingred_all_rows['image'] . '.png" type="image/png">';
						}?>
							...
							<div class="flex-grow-1 d-flex gap-2 w-80 flex-nowrap"></div>
							<?php
						...
						<span class="badge bg-primary rounded-pill align-items-center">';
