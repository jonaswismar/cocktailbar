...
<?php 
	...
	while($category_all_rows= mysqli_fetch_array($category_all_res, MYSQLI_ASSOC))
	{
		...
		$categoryicon = $category_all_rows['icon'];
...
?>
			...
			<div class="modal fade" id="newDialogCategory">
				<div class="modal-dialog modal-xl modal-fullscreen-sm-down">
					<div class="modal-content">
						<form id="category_edit" action="/api/category_save.php">
							<fieldset>
				...
				<div class="modal-dialog modal-xl modal-fullscreen-sm-down">
					<div class="modal-content">
						<form id="category_edit" action="/api/category_save.php">
							<fieldset>
								<div class="modal-header">
									<h4 class="modal-title"><i class="<?php echo $categoryicon;?> fa-2x"></i><strong> <?php echo $categoryname;?></strong> bearbeiten</h4>
									<button type="button" class="btn-close" data-bs-dismiss="modal"></button>
								</div>
								<div class="modal-body">
			...
			<div class="modal fade" id="deleteDialogCategory">
				<div class="modal-dialog modal-xl modal-fullscreen-sm-down">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title"><i class="<?php echo $categoryicon;?> fa-2x"></i><strong> <?php echo $categoryname;?></strong> löschen</h4>
							<button type="button" class="btn-close" data-bs-dismiss="modal"></button>
						</div>
						<div class="modal-body">
			...
			<form action="/api/category_save.php" method="POST">
				<fieldset>
					<div class="d-flex gap-3 p-3 flex-row justify-content-center">
						<i class="<?php echo $categoryicon;?> fa-4x"></i>
						<input name="categoryicon" class="form-control" type="hidden" value="<?php echo $categoryicon;?>" autocomplete="off" spellcheck="false" readonly>
						<input name="categoryid" class="form-control" type="hidden" value="<?php echo $categoryid;?>" readonly>
