			...
			?>
				<nav class="navbar navbar-dark fixed-top bg-primary text-white" style="z-index: 900; margin-top: 56px;"<?php if($_SESSION["role"] != 1){echo ' hidden';}?>>
					<div class="container-fluid justify-content-start">
						<button type="button" class="btn btn-primary<?php if($_SESSION["role"] != 1){echo ' disabled';}?>" data-bs-toggle="modal" data-bs-target="#newDialogUnit">
							<i class="fa-duotone fa-solid fa-file fa-fw"></i>
						</button>
						<button type="button" class="btn btn-primary<?php if($_SESSION["role"] != 1){echo ' disabled';}?>" data-bs-toggle="modal" data-bs-target="#editDialogUnit">
							<i class="fa-duotone fa-solid fa-pencil fa-fw"></i>
						</button>
						<button type="button" class="btn btn-primary<?php if($_SESSION["role"] != 1){echo ' disabled';}?>" data-bs-toggle="modal" data-bs-target="#deleteDialogUnit">
								...
								<fieldset>
									...
									<div class="modal-body">
										...
										<div class="d-flex p-3 justify-content-around flex-wrap">
											<input name="unitimage" class="form-control form-control-lg" type="text" placeholder="Fontawesome Icon Name">
										</div>
										<div class="d-flex p-3 justify-content-around flex-wrap">
											<input name="unitname" class="form-control form-control-lg" type="text" placeholder="Name der Einheit">
										</div>
										<div class="d-flex p-3 justify-content-around flex-wrap">
											<input name="unitshort" class="form-control form-control-lg" type="text" placeholder="Kürzel (Einzahl)" value="<?php echo $unitshort;?>">
											<input name="unitshortX" class="form-control form-control-lg" type="text" placeholder="Kürzel (Mehrzahl)" value="<?php echo $unitshortX;?>">
										</div>
										<div class="d-flex p-3 justify-content-around flex-wrap">
											<textarea name="unitdescription" class="form-control auto-resize" type="text" placeholder="Beschreibung der Einheit" rows="25"></textarea>
										</div>
									</div>
							...
							<form id="unit_edit" action="/views/unit_save.php">
								<fieldset>
									...
									<div class="modal-body">
										...
										<div class="d-flex p-3 justify-content-around flex-wrap">
											<input name="unitimage" class="form-control form-control-lg" type="text" placeholder="Fontawesome Icon Name" value="<?php echo $unitimage;?>">
										</div>
										<div class="d-flex p-3 justify-content-around flex-wrap">
											<input name="unitname" class="form-control form-control-lg" type="text" placeholder="Name der Einheit" value="<?php echo $unitname;?>">
										</div>
										<div class="d-flex p-3 justify-content-around flex-wrap">
											<input name="unitshort" class="form-control form-control-lg" type="text" placeholder="Kürzel (Einzahl)" value="<?php echo $unitshort;?>">
											<input name="unitshortX" class="form-control form-control-lg" type="text" placeholder="Kürzel (Mehrzahl)" value="<?php echo $unitshortX;?>">
										...
										<div class="d-flex p-3 justify-content-around flex-wrap">
											<textarea name="unitdescription" class="form-control auto-resize" type="text" placeholder="Beschreibung der Einheit" rows="25"><?php echo $unitdescription;?></textarea>
										</div>
									</div>
									<div class="modal-footer">
										<input class="btn btn-primary" type="submit" name="save" value="Speichern">
