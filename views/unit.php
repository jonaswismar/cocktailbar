...
?>
			...
			<div class="modal fade" id="newDialogUnit">
				<div class="modal-dialog modal-xl modal-fullscreen-sm-down">
					<div class="modal-content">
						<form id="unit_edit" action="/api/unit_save.php">
							<fieldset>
				...
				<div class="modal-dialog modal-xl modal-fullscreen-sm-down">
					<div class="modal-content">
						<form id="unit_edit" action="/api/unit_save.php">
							<fieldset>
								<div class="modal-header">
									<h4 class="modal-title"><i class="<?php echo $uniticon;?> fa-2x"></i><strong> <?php echo $unitname;?></strong> bearbeiten</h4>
									<button type="button" class="btn-close" data-bs-dismiss="modal"></button>
								</div>
								<div class="modal-body">
			...
			<div class="modal fade" id="deleteDialogUnit">
				<div class="modal-dialog modal-xl modal-fullscreen-sm-down">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title"><i class="<?php echo $uniticon;?> fa-2x"></i><strong> <?php echo $unitname;?></strong> löschen</h4>
							<button type="button" class="btn-close" data-bs-dismiss="modal"></button>
						</div>
						<div class="modal-body">
						...
						<div class="modal-footer">
							<a href="/api/unit_delete.php?unitid=<?php echo $unitid;?>" class="btn btn-danger<?php if($_SESSION["role"] != 1){echo ' disabled';}?>">Trotzdem löschen</a>
							<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Abbrechen</button>
						</div>
					</div>
				</div>
			...
			<form>
				<fieldset>
					<div class="d-flex gap-3 p-3 flex-row justify-content-center">
						<i class="fa fa-fw<?php echo $uniticon;?> fa-4x"></i>
						<input name="uniticon" class="form-control" type="hidden" value="<?php echo $uniticon;?>" autocomplete="off" spellcheck="false" readonly>
						<input name="unitid" class="form-control" type="hidden" value="<?php echo $unitid;?>" readonly>
